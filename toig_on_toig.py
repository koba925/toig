...
def setup_toig(ParentInterpreter):
    ...
    print("setup_toig", ParentInterpreter)
    ...
    i.go(r"""
        ...
        initial_env := global_env;
        initial_rules := [None, rules[1][:]];
        reset_interpreter := func () do
            global_env = enter_scope(initial_env);
            rules = [None, initial_rules[1][:]]
        end;
        reset_interpreter()
    """)
